...
def text_to_tabular(transcription,situation,output_format):

    path = 'prompt_template/situation'
    txt_file_dct = {
                    'monologue (doctor)' : f'/monologue_{output_format}.txt',
                    "dialogue (doctor-patient)" : '/dialogue_{output_format}.txt'
                    }
